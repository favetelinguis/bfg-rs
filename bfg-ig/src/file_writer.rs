...
pub fn write_results_to_file(result: TradeResult) {
    tokio::spawn(async move {
        ...
        if let Ok(mut file)  = tokio::fs::OpenOptions::new()
            ...
            let headers = "epic,size,reference,wanted_entry_level,entry_time,actual_entry_level,exit_time,exit_level,opening_range_size,strategy_version,one_r";
    ...
    fn to_csv(result: TradeResult) -> String {
        ...
        format!("{},{},{},{},{},{},{},{},{},{},{}\r\n", result.epic, result.size, reference, wanted_entry_level, result.entry_time, actual_entry_level, result.exit_time, exit_level, result.opening_range_size, result.strategy_version, result.one_r)
    }
